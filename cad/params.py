...
SHADE_OD      = 88.0   # mouth outer diameter
SHADE_APEX_D  = 44.0   # diameter at the back of the taper
SHADE_DEPTH   = 62.0   # mouth -> back of taper
SHADE_WALL    = 1.6    # thin on purpose: it hangs off an SG90
SHADE_COLLAR  = 18.0   # outward flare tying the yoke plates to the cone
